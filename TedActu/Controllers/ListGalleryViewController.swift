...
class ListGalleryViewController: UIViewController {
...
//    }
    ...
    extension ListGalleryViewController : UITableViewDataSource , UITableViewDelegate{
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "ListGalleryCell", for: indexPath) as! ListGalleryTableViewCell
            ...
            cell.imageListGallery?.image = myImages[indexPath.row]
